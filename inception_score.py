...
#MODEL_DIR = '/tmp/imagenet' # EDIT: replaced
import config
MODEL_DIR = os.path.join(config.result_dir, '_inception')

DATA_URL = 'http://download.tensorflow.org/models/image/imagenet/inception-2015-12-05.tgz'
softmax = None

tf_config = tf.ConfigProto() # EDIT: added
...
def get_inception_score(images, splits=10):
  ...
  bs = 100
  with tf.Session(config=tf_config) as sess: # EDIT: added config
    preds = []
